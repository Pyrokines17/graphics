...
public class Wireframe extends JFrame {
    ...
    private JToolBar setupToolBar(View3D view3D) {
        ...
        JRadioButton renderButton = getRenderButton(view3D);
        JRadioButton normalButton = getNormalButton(view3D);

        ButtonGroup buttonGroup = new ButtonGroup();

        buttonGroup.add(renderButton);
    ...
    private JRadioButton getRenderButton(View3D view3D) {
        //ImageIcon icon = getImageIcon("/icons/render.png");
        ImageIcon icon = null;
        JRadioButton button;
        ...
        if (icon != null) {
            ...
            button = new JRadioButton("Render");
        }

        button.setSelected(false);
        button.setToolTipText("Start render");
        button.addActionListener(e -> view3D.setDrawRays(true));

        return button;
    }

    private JRadioButton getNormalButton(View3D view3D) {
        //ImageIcon icon = getImageIcon("/icons/normal.png");
        ImageIcon icon = null;
        JRadioButton button;
        ...
        if (icon != null) {
            ...
            button = new JRadioButton("Normals");
        }

        button.setSelected(true);
        button.setToolTipText("Show normals");
        button.addActionListener(e -> view3D.setDrawRays(false));
